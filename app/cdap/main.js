...
import StatusAlertMessage from 'components/shared/StatusAlertMessage';
import ApiErrorDialog from 'components/shared/ApiErrorDialog';
            ...
            <Route
              ...
              render={(props) => {
                ...
                const MarkdownImpl = Loadable({
                  loader: () =>
                    import(
                      /* webpackChunkName: "MarkdownImplExample" */ 'components/shared/Markdown'
                    ),
                  loading: LoadingSVGCentered,
                });
