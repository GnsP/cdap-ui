  ...
  setNDigitPattern(e) {
    ...
    this.setState({
      ...
      pattern: this.patterns
        .find((pattern) => pattern.patternName === 'ndigitnumber')
        .getRegex(value),
    });
  }
      ...
      >
        ...
        <ModalBody>
          ...
          <div className="pattern-details">
            {!this.state.showEditPatternTxtBox ? this.renderPatternDetails() : null}
          </div>
        ...
        <ModalFooter>{this.renderFooterButton()}</ModalFooter>
      </Modal>
    );
  }
}
